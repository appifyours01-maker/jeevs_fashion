...
mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/jeevs_fashion_app', {
...
app.get('/api/app-config', async (req, res) => {
  ...
  try {
    ...
    const config = {
      ...
      adminId: '69b3da63f65d7336cfc7dc60',

      shopName: 'Jeevs Fashion',
...
app.listen(PORT, () => {
  ...
  console.log(`Jeevs Fashion Backend Server running on port ${PORT}`);
